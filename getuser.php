	...
	<body>
		...
		<?php
			...
			if (isset($_SESSION['email']))
				$sql = "select * from T_USER where Project Name = '".$_SESSION['email']."'";
...
print $sql;
			...
			print "Your information is entered into the database. <br/><br/>";
					...
					print 	"User Full Name  ".$fields["ProjectName"]. "<br />"
							"Username ". $fields["Username"]. "<br />"
							" Password". $fields["password"]."<br />" 
							" Employee ID". $fields["Mantis_ID"]."<br />"
							" Class". $fields["Class_level"]."<br />"
